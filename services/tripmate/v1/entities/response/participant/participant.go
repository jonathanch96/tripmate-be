...
func FromDomain(entity domainparticipant.Participant) Participant {
	result := Participant{
		...
		JoinedAt: entity.JoinedAt, DisplayName: entity.DisplayName,
	}
	...
	if entity.User != nil {
		result.User = &User{
			ID: entity.User.ID, Name: entity.User.Name, Email: entity.User.Email, AvatarURL: entity.User.AvatarURL,
			HasAccount: entity.User.HasAccount, HasLoggedIn: entity.User.HasLoggedIn,
		}
	}
	return result
}
