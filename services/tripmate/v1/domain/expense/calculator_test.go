...
func TestCalculateSplitsRequiredTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "percent allows a zero weight for someone who sat this one out", input: SplitInput{Amount: amount("100"), Currency: "PHP", SplitType: domainexpense.SplitPercent, Weights: map[uuid.UUID]decimal.Decimal{participants[0]: amount("100"), participants[1]: decimal.Zero}}, want: []string{"100", "0"}},
		{name: "percent rejects a negative weight", input: SplitInput{Amount: amount("100"), Currency: "PHP", SplitType: domainexpense.SplitPercent, Weights: map[uuid.UUID]decimal.Decimal{participants[0]: amount("110"), participants[1]: amount("-10")}}, errorCode: "VALIDATION_FAILED"},
		...
		{name: "shares allows a zero share for someone who sat this one out", input: SplitInput{Amount: amount("100"), Currency: "PHP", SplitType: domainexpense.SplitShares, Weights: map[uuid.UUID]decimal.Decimal{participants[0]: amount("5"), participants[1]: decimal.Zero, participants[2]: amount("2")}}, want: []string{"71.43", "0", "28.57"}},
		...
		{name: "shares rejects an all-zero split", input: SplitInput{Amount: amount("100"), Currency: "PHP", SplitType: domainexpense.SplitShares, Weights: map[uuid.UUID]decimal.Decimal{participants[0]: decimal.Zero, participants[1]: decimal.Zero}}, errorCode: "VALIDATION_FAILED"},
	}
